...
namespace GUI.Screens
{
    partial class SanPhamNhaCungCap
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.AutoSizeChanged += new System.EventHandler(this.SanPhamNhaCungCap_AutoSizeChanged);
            this.AutoValidateChanged += new System.EventHandler(this.SanPhamNhaCungCap_AutoValidateChanged);
            this.Load += new System.EventHandler(this.SanPhamNhaCungCap_Load);
            this.DockChanged += new System.EventHandler(this.SanPhamNhaCungCap_DockChanged);
            this.VisibleChanged += new System.EventHandler(this.SanPhamNhaCungCap_VisibleChanged);
            this.ControlAdded += new System.Windows.Forms.ControlEventHandler(this.SanPhamNhaCungCap_ControlAdded);
            this.Paint += new System.Windows.Forms.PaintEventHandler(this.SanPhamNhaCungCap_Paint);
            this.MouseClick += new System.Windows.Forms.MouseEventHandler(this.SanPhamNhaCungCap_MouseClick);
            this.ChangeUICues += new System.Windows.Forms.UICuesEventHandler(this.SanPhamNhaCungCap_ChangeUICues);
            this.Validating += new System.ComponentModel.CancelEventHandler(this.SanPhamNhaCungCap_Validating);
            this.Validated += new System.EventHandler(this.SanPhamNhaCungCap_Validated);
            this.ParentChanged += new System.EventHandler(this.SanPhamNhaCungCap_ParentChanged);
