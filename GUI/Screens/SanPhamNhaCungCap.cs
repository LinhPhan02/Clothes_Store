...
namespace GUI.Screens
{
    public partial class SanPhamNhaCungCap : UserControl
    {
        ...
        public SanPhamNhaCungCap()
        {
            ...
            {
                btn_add_spncc.Visible = false;
            }
            if (Login._checkUrlMatch("exportsanpham:QLNCC"))
            {
            ...
            if (Login._checkUrlMatch("importsanpham:QLNCC"))
            {
        ...
        void LoadDataComboBox()
        {
            ...
            cbb_category.Refresh();

            cbb_producer.Items.Clear();
            cbb_producer.Refresh();
     ...
     /*       producers = NhaCungCapBLL.GetDataAction();
        ...
        private void dgv_spncc_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            bool isUpdate = false;
            bool isDel = false;
            if (Login._checkUrlMatch("suasanphamnhacungcap:QLNCC"))
            {
                isUpdate = true;
            }
            else
            ...
            if (Login._checkUrlMatch("xoasanphamnhacungcap:QLNCC"))
            {
                isDel = true;
            }
            else
            ...
            XacNhanThucHien confirm = new XacNhanThucHien(pProducers[e.RowIndex].Id,isUpdate, isDel);
            confirm.ShowDialog();
        ...
        private void SanPhamNhaCungCap_DockChanged(object sender, EventArgs e)
        {
        }

        private void SanPhamNhaCungCap_MouseClick(object sender, MouseEventArgs e)
        {

        }

        private void SanPhamNhaCungCap_VisibleChanged(object sender, EventArgs e)
        {
            
        }

        private void SanPhamNhaCungCap_Validating(object sender, CancelEventArgs e)
        {
        }

        private void SanPhamNhaCungCap_Validated(object sender, EventArgs e)
        {

        }

        void GotFocusTest(object sender, EventArgs e)
        {
           

        }

        private void SanPhamNhaCungCap_ControlAdded(object sender, ControlEventArgs e)
        {

        }

        private void SanPhamNhaCungCap_AutoValidateChanged(object sender, EventArgs e)
        {
        }

        private void SanPhamNhaCungCap_Paint(object sender, PaintEventArgs e)
        {
          

        }

        private void SanPhamNhaCungCap_ParentChanged(object sender, EventArgs e)
        {
        }

        private void SanPhamNhaCungCap_AutoSizeChanged(object sender, EventArgs e)
        {
           
        }

        private void SanPhamNhaCungCap_ChangeUICues(object sender, UICuesEventArgs e)
        {
        }
    }
}
