...
namespace DAL
{
    public class KhachHangDAL
    {
        ...
        public bool InsertKH(KhachHangDTO kh)
        {
            ...
            try
            {
                string query = $"INSERT INTO customer (phoneNumber, name, createdAt, updateAt, total) VALUES ('{kh.Phone}', '{kh.Name}', '{kh.CreatedAt.ToString("yyyy-MM-dd hh:mm:ss")}', '{kh.UpdatedAt.ToString("yyyy-MM-dd hh:mm:ss")}', '{kh.ToTal}')";
                MySqlCommand cmd = new MySqlCommand(query, conn);
        ...
        public DataTable Show(List<KhachHangDTO> ds)
        {
            ...
            dtb.Columns.Add("Tổng tiền", typeof(int));
